...
function AddSnowEffect(Parent, SnowCount, SnowSize, Speed, Color)
    ...
    local function getSnowflakeIcon()
        local iconModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/deividcomsono/lucide-roblox-direct/refs/heads/main/source.lua"))()
        local icon = iconModule.GetAsset("snowflake")
        if icon then
            return icon
        end
        ...
        for _, name in ipairs(alternateNames) do
            local altIcon = iconModule.GetAsset(name)
            if altIcon then
                return altIcon
            end
        end
    ...
    local SnowflakeIcon = getSnowflakeIcon()
    local HasSnowflakeIcon = SnowflakeIcon ~= nil
    ...
    for i = 1, SnowCount do
        ...
        if HasSnowflakeIcon then
            ...
            Snowflake.Image = SnowflakeIcon.Url
            Snowflake.ImageColor3 = Color
            Snowflake.ImageRectOffset = SnowflakeIcon.ImageRectOffset
            Snowflake.ImageRectSize = SnowflakeIcon.ImageRectSize
            Snowflake.ImageTransparency = 0.2 + math.random() * 0.4
            Snowflake.BackgroundTransparency = 1
            Snowflake.Size = UDim2.fromOffset(SnowSize, SnowSize)
            Snowflake.Rotation = math.random(0, 360)
            Snowflake.Position = UDim2.new(0, pixelX, 0, pixelY)
            Snowflake.AnchorPoint = Vector2.new(0.5, 0.5)
            Snowflake.ZIndex = 2
            Snowflake.Parent = ClipFrame
        else
            Snowflake = Instance.new("Frame")
            Snowflake.BackgroundColor3 = Color
            Snowflake.BackgroundTransparency = 0.3
            Snowflake.Size = UDim2.fromOffset(SnowSize/2, SnowSize/2)
            Snowflake.Rotation = 45
            Snowflake.Position = UDim2.new(0, pixelX, 0, pixelY)
            Snowflake.AnchorPoint = Vector2.new(0.5, 0.5)
            Snowflake.ZIndex = 2
            Snowflake.Parent = ClipFrame
        ...
        if HasSnowflakeIcon then
            ...
            Glow.Image = SnowflakeIcon.Url
            Glow.ImageColor3 = Color3.fromRGB(200, 230, 255)
            Glow.ImageRectOffset = SnowflakeIcon.ImageRectOffset
            Glow.ImageRectSize = SnowflakeIcon.ImageRectSize
            Glow.ImageTransparency = Data.Transparency + 0.3
