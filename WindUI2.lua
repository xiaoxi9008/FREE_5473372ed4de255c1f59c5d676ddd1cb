...
Background = ar.Background or "https://raw.githubusercontent.com/xiaoxi9008/FREE_5473372ed4de255c1f59c5d676ddd1cb/refs/heads/main/IMG_20260623_000901.png",
...
function aa.Toast(ax,ay)
ay=ay or{}
local _ts=game:GetService("TweenService")
local _g=Instance.new("ScreenGui")
_g.Name="WindUI_Toast"
_g.IgnoreGuiInset=true
_g.ZIndexBehavior=Enum.ZIndexBehavior.Global
_g.ResetOnSpawn=false
_g.Parent=game:GetService("CoreGui")
local _f=Instance.new("Frame",_g)
_f.AutomaticSize=Enum.AutomaticSize.XY
_f.AnchorPoint=Vector2.new(0.5,0.8)
_f.Position=UDim2.new(0.5,0,0.8,0)
_f.BackgroundColor3=Color3.fromRGB(25,25,35)
_f.BackgroundTransparency=1
_f.ZIndex=600
Instance.new("UICorner",_f).CornerRadius=UDim.new(0,20)
local _pad=Instance.new("UIPadding",_f)
_pad.PaddingLeft=UDim.new(0,16)
_pad.PaddingRight=UDim.new(0,16)
_pad.PaddingTop=UDim.new(0,10)
_pad.PaddingBottom=UDim.new(0,10)
local _l=Instance.new("TextLabel",_f)
_l.AutomaticSize=Enum.AutomaticSize.XY
_l.BackgroundTransparency=1
_l.Text=ay.Content or""
_l.TextSize=14
_l.Font=Enum.Font.GothamBold
_l.TextColor3=Color3.fromRGB(240,240,240)
_l.TextTransparency=1
_l.ZIndex=601
_ts:Create(_f,TweenInfo.new(0.2),{BackgroundTransparency=0.1}):Play()
_ts:Create(_l,TweenInfo.new(0.2),{TextTransparency=0}):Play()
task.delay(ay.Duration or 2,function()
_ts:Create(_f,TweenInfo.new(0.2),{BackgroundTransparency=1}):Play()
_ts:Create(_l,TweenInfo.new(0.2),{TextTransparency=1}):Play()
task.wait(0.25)
_g:Destroy()
end)
end
function aa.Dialog(ax,ay)
ay=ay or{}
local _g=Instance.new("ScreenGui")
_g.Name="WindUI_Dialog"
_g.IgnoreGuiInset=true
_g.ZIndexBehavior=Enum.ZIndexBehavior.Global
_g.ResetOnSpawn=false
_g.Parent=game:GetService("CoreGui")
local _bg=Instance.new("Frame",_g)
_bg.Size=UDim2.new(1,0,1,0)
_bg.BackgroundColor3=Color3.new(0,0,0)
_bg.BackgroundTransparency=0.5
_bg.ZIndex=500
local _c=Instance.new("Frame",_bg)
_c.Size=UDim2.new(0,280,0,0)
_c.AutomaticSize=Enum.AutomaticSize.Y
_c.AnchorPoint=Vector2.new(0.5,0.5)
_c.Position=UDim2.new(0.5,0,0.5,0)
_c.BackgroundColor3=Color3.fromRGB(25,25,35)
_c.ZIndex=501
Instance.new("UICorner",_c).CornerRadius=UDim.new(0,12)
local _cp=Instance.new("UIPadding",_c)
_cp.PaddingTop=UDim.new(0,16)
_cp.PaddingBottom=UDim.new(0,16)
_cp.PaddingLeft=UDim.new(0,16)
_cp.PaddingRight=UDim.new(0,16)
local _ll=Instance.new("UIListLayout",_c)
_ll.Padding=UDim.new(0,12)
_ll.SortOrder=Enum.SortOrder.LayoutOrder
local _t=Instance.new("TextLabel",_c)
_t.LayoutOrder=0
_t.Size=UDim2.new(1,0,0,22)
_t.BackgroundTransparency=1
_t.Text=ay.Title or"Confirm"
_t.TextSize=18
_t.Font=Enum.Font.GothamBold
_t.TextColor3=Color3.fromRGB(240,240,240)
_t.TextXAlignment=Enum.TextXAlignment.Left
_t.ZIndex=502
if ay.Content then
local _d=Instance.new("TextLabel",_c)
_d.LayoutOrder=1
_d.Size=UDim2.new(1,0,0,0)
_d.AutomaticSize=Enum.AutomaticSize.Y
_d.BackgroundTransparency=1
_d.Text=ay.Content
_d.TextSize=14
_d.Font=Enum.Font.Gotham
_d.TextColor3=Color3.fromRGB(160,160,170)
_d.TextWrapped=true
_d.TextXAlignment=Enum.TextXAlignment.Left
_d.ZIndex=502
end
local _r=Instance.new("Frame",_c)
_r.LayoutOrder=2
_r.Size=UDim2.new(1,0,0,36)
_r.BackgroundTransparency=1
_r.ZIndex=502
local _bll=Instance.new("UIListLayout",_r)
_bll.FillDirection=Enum.FillDirection.Horizontal
_bll.HorizontalAlignment=Enum.HorizontalAlignment.Right
_bll.Padding=UDim.new(0,8)
local function _mkBtn(txt,col,cb)
local _b=Instance.new("TextButton",_r)
_b.Size=UDim2.new(0,90,1,0)
_b.BackgroundColor3=col
_b.Text=txt
_b.TextSize=13
...
_mkBtn(ay.CancelText or"Cancel",Color3.fromRGB(60,60,70),ay.OnCancel)
_mkBtn(ay.ConfirmText or"Confirm",Color3.fromRGB(99,102,241),ay.OnConfirm)
end
function aa.SetBadge(ax,ay,az)
if not ay then return end
local _m=ay.UIElements and ay.UIElements.Main
if not _m then return end
local _ex=_m:FindFirstChild("__WindBadge")
if _ex then _ex:Destroy() end
if not az or az==0 then return end
local _b=Instance.new("Frame",_m)
_b.Name="__WindBadge"
_b.Size=UDim2.new(0,16,0,16)
_b.AnchorPoint=Vector2.new(1,0)
_b.Position=UDim2.new(1,2,0,-2)
_b.BackgroundColor3=Color3.fromRGB(239,68,68)
_b.ZIndex=(_m.ZIndex or 1)+10
Instance.new("UICorner",_b).CornerRadius=UDim.new(1,0)
local _bl=Instance.new("TextLabel",_b)
_bl.Size=UDim2.new(1,0,1,0)
_bl.BackgroundTransparency=1
_bl.Text=az>99 and"99+"or tostring(az)
_bl.TextSize=9
_bl.Font=Enum.Font.GothamBold
_bl.TextColor3=Color3.fromRGB(255,255,255)
_bl.ZIndex=_b.ZIndex+1
end
...
local ag={__type="ProgressBar",Title=af.Title or"Progress",Value=af.Value or 0,Max=af.Max or 100,Color=af.Color or Color3.fromRGB(99,102,241),Locked=af.Locked or false,UIElements={}}
local ah=a.load'z'{Title=ag.Title,Desc=" ",Window=af.Window,Parent=af.Parent,TextOffset=0,Hover=false,Tab=af.Tab,Index=af.Index,ElementTable=ag,ParentConfig=af}
ag.ProgressBarFrame=ah
local ai=ab("Frame",{Size=UDim2.new(1,-24,0,8),BackgroundColor3=Color3.fromRGB(50,50,60),BackgroundTransparency=0,Parent=ah.UIElements.Container},{ab("UICorner",{CornerRadius=UDim.new(1,0)})})
local aj=ab("Frame",{Size=UDim2.new(0,0,1,0),BackgroundColor3=ag.Color,BackgroundTransparency=0,Parent=ai},{ab("UICorner",{CornerRadius=UDim.new(1,0)})})
function ag.SetValue(ak,al)
ag.Value=math.clamp(al,0,ag.Max)
ac(aj,0.3,{Size=UDim2.new(ag.Value/ag.Max,0,1,0)}):Play()
ah:SetDesc(math.floor(ag.Value/ag.Max*100).."%")
end
function ag.SetMax(ak,al)
ag.Max=al
ag:SetValue(ag.Value)
end
function ag.SetTitle(ak,al)
ag.Title=al
ah:SetTitle(al)
end
function ag.SetColor(ak,al)
ag.Color=al
aj.BackgroundColor3=al
end
function ag.Lock(ak)
ag.Locked=true
return ah:Lock()
end
function ag.Unlock(ak)
ag.Locked=false
return ah:Unlock()
end
if ag.Locked then ag:Lock() end
ag:SetValue(ag.Value)
return ag.__type,ag
end
return ad
...
local ac={}
function ac.New(ad,ae)
local af={__type="Badge",Title=ae.Title or"Badge",Text=ae.Text or ae.Title or"Badge",Color=ae.Color or Color3.fromRGB(99,102,241),Locked=ae.Locked or false,UIElements={}}
local ag=a.load'z'{Title=af.Title,Desc=nil,Window=ae.Window,Parent=ae.Parent,TextOffset=0,Hover=false,Tab=ae.Tab,Index=ae.Index,ElementTable=af,ParentConfig=ae}
af.BadgeFrame=ag
local ah=ab("Frame",{AutomaticSize=Enum.AutomaticSize.XY,BackgroundColor3=af.Color,BackgroundTransparency=0.2,Parent=ag.UIElements.Container},{ab("UICorner",{CornerRadius=UDim.new(1,0)}),ab("UIPadding",{PaddingLeft=UDim.new(0,10),PaddingRight=UDim.new(0,10),PaddingTop=UDim.new(0,3),PaddingBottom=UDim.new(0,3)})})
local ai=ab("TextLabel",{AutomaticSize=Enum.AutomaticSize.XY,BackgroundTransparency=1,Text=af.Text,TextSize=13,FontFace=Font.new(aa.Font,Enum.FontWeight.Bold),TextColor3=Color3.fromRGB(255,255,255),Parent=ah})
function af.SetText(aj,ak)
af.Text=ak
ai.Text=ak
end
function af.SetColor(aj,ak)
af.Color=ak
ah.BackgroundColor3=ak
end
function af.Lock(aj)
af.Locked=true
return ag:Lock()
...
local ac={}
function ac.New(ad,ae)
local af={__type="LineChart",Title=ae.Title or"Chart",MaxPoints=ae.MaxPoints or 30,Color=ae.Color or Color3.fromRGB(99,102,241),Height=ae.Height or 60,Locked=ae.Locked or false,UIElements={},_data={},_lines={},_visible=true}
local ag=a.load'z'{Title=af.Title,Desc=" ",Window=ae.Window,Parent=ae.Parent,TextOffset=0,Hover=false,Tab=ae.Tab,Index=ae.Index,ElementTable=af,ParentConfig=ae}
af.ChartFrame=ag
local ah=ab("Frame",{Size=UDim2.new(1,-24,0,af.Height),BackgroundColor3=Color3.fromRGB(20,20,28),BackgroundTransparency=0,ClipsDescendants=true,Parent=ag.UIElements.Container},{ab("UICorner",{CornerRadius=UDim.new(0,6)})})
local function _redraw()
for _,v in ipairs(af._lines) do pcall(function()v.Visible=false end) end
af._lines={}
local dt=af._data
if #dt<2 then return end
local mn,mx=dt[1],dt[1]
for _,v in ipairs(dt) do
if v<mn then mn=v end
if v>mx then mx=v end
end
if mx==mn then mx=mn+1 end
local W=ah.AbsoluteSize.X
local H=ah.AbsoluteSize.Y
local ox=ah.AbsolutePosition.X
local oy=ah.AbsolutePosition.Y
for i=1,#dt-1 do
local ln=Drawing.new("Line")
ln.From=Vector2.new(ox+(i-1)/(#dt-1)*W,oy+H-((dt[i]-mn)/(mx-mn))*H)
ln.To=Vector2.new(ox+i/(#dt-1)*W,oy+H-((dt[i+1]-mn)/(mx-mn))*H)
ln.Color=af.Color
ln.Thickness=2
ln.Transparency=1
ln.Visible=af._visible
table.insert(af._lines,ln)
end
end
function af.AddPoint(ai,v)
table.insert(af._data,v)
if #af._data>af.MaxPoints then table.remove(af._data,1) end
_redraw()
end
function af.SetData(ai,d)
af._data=d
_redraw()
end
function af.SetColor(ai,c)
af.Color=c
_redraw()
end
function af.SetVisible(ai,v)
af._visible=v
for _,ln in ipairs(af._lines) do ln.Visible=v end
end
function af.SetTitle(ai,t)
af.Title=t
ag:SetTitle(t)
end
function af.Lock(ai)
